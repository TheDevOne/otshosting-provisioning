You may be looking for our --> [DOCUMENTATION on wiki](https://github.com/TheDevOne/otshosting-provisioning/wiki) <--
...
ansible-pull -i localhost, -U https://github.com/TheDevOne/otshosting-provisioning.git -d /srv/otshosting-provisioning --purge
```
